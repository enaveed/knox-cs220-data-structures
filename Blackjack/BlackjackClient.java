...
public class BlackjackClient {
    ...
    private static final String USERNAME = "myname123"; // replace with your username
    private static final String PASSWORD = "mypassword123"; // replace with your from the file posted to Classroom
